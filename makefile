...
SRCS += stm32g0xx_hal_gpio.c app_serial.c stm32g0xx_hal_fdcan.c	app_clock.c stm32g0xx_hal_rtc.c stm32g0xx_hal_rtc_ex.c stm32g0xx_hal_pwr.c stm32g0xx_hal_pwr_ex.c
